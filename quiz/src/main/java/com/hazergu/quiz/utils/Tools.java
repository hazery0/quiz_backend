package com.hazergu.quiz.utils;

import com.hazergu.quiz.model.QSBeanOutManage;
...
public class Tools {
    ...
    public static List<QSBeanOutManage> convertToQSBeanManageList(List<Question> questionList) {
        ...
        for (Question question : questionList) {
            ...
            // 查找正确答案字母（A, B, C, D）
            bean.setAnswer(determineCorrectAnswerLetter(question));
            result.add(bean);
        }
    ...
    private static String determineCorrectAnswerLetter(Question question) {
